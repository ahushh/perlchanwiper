...
my $random_reply = {
                    ...
                    interval => 60*5, #-- интервал обновления списк постов
...
our %mode_config = (
    ...
    post_timeout      => 90,      #-- ... на создание поста
    ...
    proxy_attempts    => 30,       #-- сколько раз пробовать скачать капчу/отправить пост, прежде чем считать прокси плохой
    on_exit           => {
