...
our %mode_config = (
    ...
    prepare_timeout   => 299 ,     #-- ... на получение капчи, создание контента и т.д.
    ...
    max_pst_thrs      => 180,     #-- максимальное количество одновременно запущенных потоков с созданием постов
    max_cap_thrs      => 20 ,     #-- ...с получением капчи
    max_prp_thrs      => 6  ,     #-- ...с распознаванием, создание контента, и т.д.
    ...
    flood_limit       => 60*0.9,  #-- задержка в секундах перед повторной отправкой поста
