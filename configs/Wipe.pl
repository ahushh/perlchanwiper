...
our %mode_config = (
    ...
    max_pst_thrs      => 120,     #-- максимальное количество одновременно запущенных потоков с созданием постов
    ...
    post_attempts     => 20,       #-- ... отправить пост повторно при ошибках timeout/net error/unknown error; пока что игнорирует max_post_thrs
