...
our %mode_config = (
    ...
    max_pst_thrs      => 25,      #-- максимальное колличество одновременно запущенных потоков с созданием постов
    max_cap_thrs      => 25,      #-- ...с получением капчи
    max_prp_thrs      => 25,      #-- ...с распознаванием, создание контента, и т.д.
