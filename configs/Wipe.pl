...
my $w_target_cnf = { 
                    ...
                    threads => {
                                #post_limit => 300,  #-- TODO
                                regexp  => '(\d+):(\d+)|--|400x400',   #-- фильтровать по регэкспу
...
our %mode_config = (
    ...
    max_pst_thrs      => 20,     #-- максимальное колличество одновременно запущенных потоков с созданием постов
    max_cap_thrs      => 70,     #-- ...с получением капчи
    max_prp_thrs      => 1,     #-- ...с распознаванием, создание контента, и т.д.
