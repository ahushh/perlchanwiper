...
#-- Difference from the original file: replaced sleep with Coro::Timer::sleep
...
our $DELAY  = 5;              # Coro::Timer::sleep time before retry while uploading or recognizing captcha
...
$WebService::Antigate::DELAY    = 5;              # Coro::Timer::sleep time before retry while uploading or recognizing captcha
